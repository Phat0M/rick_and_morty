...
/// {@template string_analytics_parameter}
/// Analytics parameter that contains a [bool] value.
/// {@endtemplate}
final class BoolAnalyticsParameter extends AnalyticsParameter<bool> {
  /// {@macro string_analytics_parameter}
  // ignore: avoid_positional_boolean_parameters
  const BoolAnalyticsParameter(super.name, super.value);

  @override
  String toString() => '$BoolAnalyticsParameter(name: $name, value: $value)';

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is BoolAnalyticsParameter && other.name == name && other.value == value;
  }
